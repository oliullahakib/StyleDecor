    ...
    return (
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-content">
                {/* Navbar */}
                <nav className="navbar flex justify-between w-full bg-base-200">
                    ...
                    <ul className="menu w-full grow">
                        ...
                        <li>
                            <Link to={'/'} className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Homepage">
                                <h1 className="is-drawer-close:hidden text-primary text-2xl">Style <span className='text-secondary'>StyleDecor</span></h1>
                            </Link>
                        </li>
                        {/* List item */}
                        <li>
